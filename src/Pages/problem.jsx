      ...
      <div className="pageContainer">
        ...
        <div className="container" data-aos="fade-up">
          <div className="container1">
            <div id='cleanup' className="imgContainer" style={{ padding: '5px' }}>
              <img src={AMDImage} alt="AMD" />
              <p style={{ fontSize: '10px', marginBottom: 0, color: '#ffffffa2' }}>
                &nbsp;Source: Wayne National Forest. <a style={{ color: '#ffffffa2' }} href="https://creativecommons.org/publicdomain/mark/1.0/">Creative Commons</a>
              </p>
            </div>
        ...
        <a href="/AMD-GC/solution" onClick={handleScrollToTop}>
          <button className="readMore">Read About Our Solution &gt;&gt;</button>
        </a>
      </div>
    </div>
  );
